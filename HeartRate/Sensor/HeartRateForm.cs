...
namespace HeartRateSensor
{
    public partial class HeartRateForm : Form
    {
        ...
        private void HeartRateForm_Load(object sender, EventArgs e)
        {
            ...
            this.avatarTextBox.Text = Properties.Settings.Default.AvatarUrl;
            this.authorTextBox.Text = Properties.Settings.Default.AuthorId;
                    ...
                    if (this.sendToExobrainCheckBox.Checked && int.TryParse(_iconText, out int rateValue) && DateTime.Now.Second % Properties.Settings.Default.Interval == 0)
                    {
                        this.neuronApplicationService.CreateNeuron(
                                ...
                                new Terminal[] {
                                    ...
                                    new Terminal() { Strength = 1, Effect = NeurotransmitterEffect.Excite, TargetId = Properties.Settings.Default.HeartRateId }
                                },
